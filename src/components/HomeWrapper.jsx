...
function HomeWrapper({children}) {
  ...
  return (
    <div className='w-full max-w-8xl mx-auto  '> 
     ...
     <p className=' text-black text-center text-[23px] '>Your go-to destination for insightful articles, fresh ideas, and engaging stories. Whether you're here for inspiration, knowledge, or just a good read, we've got something for everyone. Explore, discover, and stay curious!</p>
     </div>
      
      <div className='px-12'>
        
          <div className='flex justify-center mb-16'>
            <p className='  text-center text-6xl pb-3 border-b-2 border-slate-600 font-semibold text-slate-500'>Top Articles</p>
          </div>
          

          {children}

            {!status ? <p className='text-[1.5rem]'>
