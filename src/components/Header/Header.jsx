        ...
        <div className={ `w-full h-screen  bg-[rgba(150,150,150,0.5)]  ${visible ? 'left-0 '  : ' -left-full' } top-0 transition-all duration-100  xl:hidden fixed z-30`} onClick={() => {
          ...
          <div className='w-[70%] h-[100vh]  bg-slate-400 pt-8 pl-4 ' onClick={(e) => {
            ...
            setVisible(false)
              ...
              <svg className='w-[30px] h-[30px] text-white'  id="Layer_1"  version="1.1" viewBox="0 0 512 512" width="512px" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
        ...
        <div className='flex items-center justify-between'>
          ...
          <div className='  xl:hidden ' onClick={() => {
           ...
           setVisible(true)
            ...
            <svg className='w-[50px] h-[50px] pr-4' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"  viewBox="0 0 50 50">
